...
export default class Preloader extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON('dungeon', '../public/assets/dungeon_1.json');
    ...
    this.load.atlas(
      'warrior',
      '../public/spriteSheet/warrior.png',
      '../public/spriteSheet/warrior.json'
    );

    this.load.atlas(
      'wizzard',
      '../public/spriteSheet/enemy/wizzard.png',
      '../public/spriteSheet/enemy/wizzard.json'
    );
  } //end of preload
